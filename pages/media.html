...
<h1 class="display-4">Mediasisältö</h1>
  ...
  <div class="row text-center text-lg-left">
    ...
    <div class="col-lg-3 col-md-4 col-6" >
      <a class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="./img/hazard.jpg" alt="">
			<p class="text-center"></p>
          </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
      <a class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="./img/swordBG.jpg" alt="">
			<p class="text-center"></p>
          </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
      <a class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="./img/sh0xBG.jpg" alt="">
			<p class="text-center"></p>
          </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
      <a class="d-block mb-4 h-100">
            <img class="img-fluid img-thumbnail" src="./img/wmlg2.png" alt="">
			<p class="text-center"></p>
          </a>
    </div>
