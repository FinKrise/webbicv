...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#kale">KaLe-projekti</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#peli">Unity-peli</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#pukki">Varauspukki-palvelu</a>
  </li>
</ul>
<div id="myTabContent" class="tab-content">
  ...
  <div class="tab-pane fade" id="pukki">
